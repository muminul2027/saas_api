...
Offering User Authentication, Authorization, Team-based Task Assignment, RBAC With JWT and a Scalable Dockerized SQLite to PostgreSQL Database Architecture.
...
Task Management in a Small Team.
It use **ES256** for its High Performance and Robust Security.
It is Cloud-Based. Can be Deployed with Skins, Upgrades and Subcription Model.
...
**Architecture**
    ...
    Pydantic Validation
        |
    Service.py <-> Argon2 (Cryptography)
        |
    SQLAlchemy ORM
        |
    SQLite / PostgreSQL
...
-Team Management with Supervisor,Admin Role.
-Task Management with Create, Read ,Update, Delete Task.
-SQL Database with Migration Facility (**Alembic**).
-Pagination. Can be Upgraded to Rate Limit and Caching.
-Dockerized Deployment.
-Clean RestAPI Architecture.
...
This Project is for Demonstration of Practice and Experience On Building Scalable, Maintainable, Secured API.
Ideal Portfolio Showcase for Startup and Small Team Seeking a Fast and Reliable Developer.
...
Vist Github Page For More Fungithub_url Projects
